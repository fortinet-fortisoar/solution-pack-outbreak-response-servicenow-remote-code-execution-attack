...
2. From the list of solution pack that appears, search **Outbreak Response - ServiceNow Remote Code Execution Attack**.
3. Click the **Outbreak Response - ServiceNow Remote Code Execution Attack** solution pack card.
4. Click **Install** on the lower part of the screen to begin the installation.

## Prerequisites
The **Outbreak Response - ServiceNow Remote Code Execution Attack** solution pack depends on the following solution packs that are installed automatically & if not already installed.
